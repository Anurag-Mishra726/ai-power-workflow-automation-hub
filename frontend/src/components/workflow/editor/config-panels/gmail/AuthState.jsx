      ...
      <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-400">Allow FlowAI to access and automate your emails.</p>
          </div>
        </div>
        ...
        <ul className="space-y-3 mb-6">
          ...
          <li className="flex items-start gap-2 text-sm text-zinc-300">
            <CheckCircle2 className="w-4 h-4 mt-0.5 text-green-500 shrink-0" />
            Send and delete emails from workflow actions.
          </li>
          <li className="flex items-start gap-2 text-sm text-zinc-300">
            <CheckCircle2 className="w-4 h-4 mt-0.5 text-green-500 shrink-0" />
            Reconnect anytime when token expires.
          </li>
        </ul>

        <button
          onClick={handleConnect}
          className="w-full flex items-center justify-center gap-2 bg-[#EA4335] hover:bg-[#cb3a2d] text-white font-semibold py-3 px-4 rounded-xl transition-all active:scale-[0.98] disabled:opacity-50"
        >
